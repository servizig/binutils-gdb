...
static CORE_ADDR
amd64dfly_sigcontext_addr (const struct frame_info_ptr &this_frame)
{
...
static CORE_ADDR
amd64dfly_get_thread_local_address (struct gdbarch *gdbarch, ptid_t ptid,
				    CORE_ADDR lm_addr, CORE_ADDR offset)
{
  ...
  return dfly_get_thread_local_address (gdbarch, dtv_addr, lm_addr, offset);
}
...
amd64dfly_init_abi (struct gdbarch_info info, struct gdbarch *gdbarch)
{
  ...
  set_gdbarch_get_thread_local_address (gdbarch,
					amd64dfly_get_thread_local_address);
}
